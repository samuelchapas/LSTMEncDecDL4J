...
public class NeuralNet {
	...
	char[] LEARNSTRING;
	private LinkedHashSet<Character> LEARNSTRING_CHARS;
	...
	public void run(String[] args) {
		...
		LEARNSTRING_CHARS = new LinkedHashSet<>();
	...
	private void restoreModel(File networkFile) {
		try {
	...
	private void trainModel(File networkFile, char[] STRING) {
	...
	private void autocompleteWord(char[] word4Autocomplete){
		
		LEARNSTRING = word4Autocomplete;
		System.out.println(LEARNSTRING.toString() + " " + LEARNSTRING.length);
        ...
        while (defaultCharacterList.get(sampledCharacterIdx) != 
        		defaultCharacterList.get(defaultCharacterList.indexOf(space))) {
